...
export default function Productos() {
  ...
  const [paginaActual, setPaginaActual] = useState(1);
    ...
    useEffect(() => {
    document.title = "Centro de Kinesiología Kareh | Productos";
    ...
    // Meta tags básicos
    updateMetaTag('description', 'Centro de Kinesiología Kareh. Servicios de rehabilitación y tratamientos especializados.');
    updateMetaTag('keywords', 'kinesiología, fisioterapia, rehabilitación, terapia física, tratamientos');
    updateMetaTag('author', '@webmaster');
    updateMetaTag('robots', 'index, follow');

    // Open Graph
    updateMetaTag('og:title', 'Centro de Kinesiología Kareh', 'property');
    updateMetaTag('og:description', 'Servicios profesionales de kinesiología y rehabilitación.', 'property');
